...
//
//        hashTable.add(202039, new Aluno(202039, "Mauricio"));

        hashTable.add(202401, new Aluno(202401, "Lucas"));
        hashTable.add(202401, new Aluno(202401, "Pedro"));
        hashTable.add(202401, new Aluno(202401, "Maria"));

        hashTable.add(202035, new Aluno(202035, "x"));
        hashTable.add(202035, new Aluno(202035, "y"));
        hashTable.add(202035, new Aluno(202035, "z"));
        hashTable.add(202035, new Aluno(202035, "a"));
        hashTable.add(202035, new Aluno(202035, "b"));
        hashTable.add(202035, new Aluno(202035, "c"));
        hashTable.print();
    }
}
